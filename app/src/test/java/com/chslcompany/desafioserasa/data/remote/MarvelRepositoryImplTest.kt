...
class MarvelRepositoryImplTest : TestCase() {
    ...
    fun `test response repository`() = testCoroutinesDispatcher.runBlockingTest {
        ...
        Mockito.doReturn(response)
            .`when`(api).getCharacters(Mockito.anyLong(), Mockito.anyString(), Mockito.anyString())

        repository.getCharacters(Mockito.anyLong(), Mockito.anyString(), Mockito.anyString()).let {
