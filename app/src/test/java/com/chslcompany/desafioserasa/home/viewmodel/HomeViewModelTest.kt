package com.chslcompany.desafioserasa.home.viewmodel
...
import com.chslcompany.desafioserasa.domain.usecase.dbcrud.InsertCrudDbUseCaseImpl
import com.chslcompany.desafioserasa.domain.usecase.getcharacters.GetCharactersUseCaseImpl
import com.chslcompany.desafioserasa.ui.home.HomeViewModel
...
class HomeViewModelTest {
    ...
    private var mockGetCharactersImpl = Mockito.mock(GetCharactersUseCaseImpl::class.java)
    private var mockInsertCrudDbUseCaseImpl = Mockito.mock(InsertCrudDbUseCaseImpl::class.java)
    ...
    fun `testing get Characters loading`() = testCoroutineDispatcher.runBlockingTest{
        ...
        Mockito.doReturn(mockResponse()).`when`(mockGetCharactersImpl).invoke(
    ...
    fun `testing get characters error state`() = testCoroutineDispatcher.runBlockingTest {
        ...
        testCoroutineDispatcher.resumeDispatcher()
        Truth.assertThat(viewModel.response.value).isEqualTo(State.error<CharactersResponse>(
            IOException()
        ))
    }
    ...
    fun `testing insert loading`() = testCoroutineDispatcher.runBlockingTest{
        ...
        Mockito.doReturn(true).`when`(mockInsertCrudDbUseCaseImpl).invoke(mockResult())
